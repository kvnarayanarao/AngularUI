(function() {
    ...
    angular.module("ABC").controller("mainBController", ['config', '$scope', '$rootScope', 'chartHandlerService', '$route', '$routeParams', 'requestHandlers', '$timeout', 'Crossfilter',
        function(config, $scope, $rootScope, chartHandler, $route, $routeParams, requestHandlers, $timeout, Crossfilter) {
                ...
                requestHandlers.requestMapService(config.data.menuBJSON).then(
